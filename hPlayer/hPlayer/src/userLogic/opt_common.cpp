...
static int get_codecs_sorted(const AVCodecDescriptor ***rcodecs)
{
    ...
    while ((desc = (AVCodecDescriptor *)avcodec_descriptor_next(desc)))
        nb_codecs++;
...
int opt_cpucount(void *optctx, const char *opt, const char *arg)
{
    ...
    static const AVClass classT = {
        .class_name = "cpucount",
        .item_name  = av_default_item_name,
        .option     = opts,
        .version    = LIBAVUTIL_VERSION_INT,
    };
    const AVClass *pclass = &classT;
...
static void expand_filename_template(AVBPrint *bp, const char *templateT,
                                     struct tm *tm)
{
    int c;
