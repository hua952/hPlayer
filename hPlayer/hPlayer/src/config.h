...
#define FFMPEG_CONFIGURATION "--prefix=/output/windows --arch=x86_64 --target-os=mingw32 --cross-prefix=x86_64-w64-mingw32- --enable-cross-compile --enable-shared --disable-static --enable-gpl --enable-nonfree --enable-libx264 --enable-libass --enable-libfreetype --enable-libfribidi --disable-schannel --enable-sdl2 --enable-ffplay --extra-cflags=-I/win_prefix/include --extra-ldflags=-L/win_prefix/lib"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2025
#define FFMPEG_DATADIR "/output/windows/share/ffmpeg"
#define AVCONV_DATADIR "/output/windows/share/ffmpeg"
